...
(function() {
    ...
    function embedIframe() {
      ...
      iframe.src = 'https://squareup.com/appointments/buyer/widget/1p0i36qz6ofgzp/LGTSXKPQNNMNN';
    ...
    function embedBookingButton() {
      ...
      button.setAttribute("href", 'https://squareup.com/appointments/book/1p0i36qz6ofgzp/LGTSXKPQNNMNN/start');
    ...
    if (takeOverIframe()) {
      window.location = 'https://squareup.com/appointments/buyer/widget/1p0i36qz6ofgzp/LGTSXKPQNNMNN';
    } else {
